...
class ubuntu_ltp_cve(test.test):
    version = 1
    ...
    def run_once(self, test_name):
        ...
        if test_name == 'zram01':
        ...
        elif test_name in ['cve-2018-1000204', 'ioctl_sg01']:
            ...
            os.environ["LTP_TIMEOUT_MUL"] = LTP_TIMEOUT_MUL
        elif test_name == 'cve-2017-5754':
            print("Setting LTP_TIMEOUT_MUL={} for cve-2017-5754 (lp:1981780)".format(LTP_TIMEOUT_MUL))
            os.environ["LTP_TIMEOUT_MUL"] = LTP_TIMEOUT_MUL
        elif test_name in ['cve-2017-15299', 'cve-2017-15951']:
            print("Setting LTP_TIMEOUT_MUL={} for cve-2017-15299 / cve-2017-15951 (lp:1983299)")
            os.environ["LTP_TIMEOUT_MUL"] = LTP_TIMEOUT_MUL
        elif test_name == 'fs_fill':
            print("Setting LTP_TIMEOUT_MUL={} for fs_fill".format(LTP_TIMEOUT_MUL))
            os.environ["LTP_TIMEOUT_MUL"] = LTP_TIMEOUT_MUL
        elif test_name == 'read_all_proc':
            print("Setting LTP_TIMEOUT_MUL={} for read_all_proc".format(LTP_TIMEOUT_MUL))
            os.environ["LTP_TIMEOUT_MUL"] = LTP_TIMEOUT_MUL
        elif test_name == 'read_all_sys':
